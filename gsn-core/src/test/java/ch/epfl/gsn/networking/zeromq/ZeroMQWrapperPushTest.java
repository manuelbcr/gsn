...
public class ZeroMQWrapperPushTest {
    
    private static StorageManager sm;
    private ZeroMQWrapperPush wrapper;
    ...
    public void testInitialize(){
        ...
        assertEquals("ZeroMQ wrapper Push",wrapper.getWrapperName());
        assertNotNull(wrapper.getOutputFormat());
    }
}
