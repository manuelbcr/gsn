...
public class SystemMonitoringWrapper extends AbstractWrapper {
   ...
   private transient DataField [ ]   outputStructureCache                  = new DataField [ ] { 
                                                                                ...
                                                                                new DataField( FIELD_NAME_MAX_HEAP , "bigint" , "Maximum amount of HEAP memory in bytes that can be used for memory management" ) ,
                                                                                new DataField( FIELD_NAME_NON_HEAP , "bigint" , "Nonheap memory usage." ) , 
                                                                                new DataField( FIELD_NAME_PENDING_FINALIZATION_COUNT , "int" , "The number of objects with pending finalization."),
                                                                                ...
                                                                                new DataField( FIELD_NAME_PEAK_THREAD_COUNT , "int" , "peak live thread count since the Java virtual machine started" ),
   ...
   private static final String [ ]   FIELD_NAMES                           = new String [ ] { FIELD_NAME_HEAP , FIELD_NAME_MAX_HEAP, FIELD_NAME_NON_HEAP, FIELD_NAME_PENDING_FINALIZATION_COUNT, FIELD_NAME_SYSTEM_LOAD_AVERAGE,FIELD_NAME_THREAD_COUNT,FIELD_NAME_PEAK_THREAD_COUNT,FIELD_NAME_UPTIME,FIELD_NAME_BLOCKED_THREADS,FIELD_NAME_NEW_THREADS,FIELD_NAME_RUNNABLE_THREADS,FIELD_NAME_WAITING_THREADS,FIELD_NAME_TERMINATED_THREADS };
   ...
   public boolean initialize ( ) {
      ...
      if ( addressBean.getPredicateValue( "sampling-rate" ) != null ) {
         ...
         if ( samplingRate <= 0 ) {
            logger.warn( "The specified >sampling-rate< parameter for the >SystemMonitoringWrapper< should be a positive number.\nGSN uses the default rate (" + DEFAULT_SAMPLING_RATE + "ms )." );
