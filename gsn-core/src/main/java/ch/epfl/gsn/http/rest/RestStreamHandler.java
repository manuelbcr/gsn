...
import ch.epfl.gsn.http.ac.DataSource;
import ch.epfl.gsn.http.ac.GeneralServicesAPI;
import ch.epfl.gsn.http.ac.User;
...
public class RestStreamHandler extends HttpServlet implements ContinuationListener {
	...
	public void doGet ( HttpServletRequest request , HttpServletResponse response ) throws ServletException{
		...
		if(continuation.isInitial()) {
            ...
            try {
                ...
                DataDistributerRest.getInstance(deliverySystem.getClass()).addListener(streamingReq);
			}catch (Exception e) {
        ...
        if (authHeader != null) {
            ...
            if (ahs.length == 2) {
                ...
                try {
                    ...
                    String userPass = new String(decoder.decode(b64UsernamPassword), "UTF-8");
					String[] ups;
