...
@Singleton
public class GSNStupidBasicAuthProvider extends BasicAuthProvider {

	private final UserProvider userProvider;

	private final Form<GSNUsernamePasswordAuthProvider.MyLogin> LOGIN_FORM;

	@Inject
	public GSNStupidBasicAuthProvider(final PlayAuthenticate auth, final UserProvider userProvider,
									 final FormFactory formFactory,
									 final ApplicationLifecycle lifecycle) {
		super(auth, lifecycle);
		this.userProvider = userProvider;
		this.LOGIN_FORM = formFactory.form(GSNUsernamePasswordAuthProvider.MyLogin.class);
	}
